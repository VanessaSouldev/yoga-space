    ...
    return (<>
            ...
            <section id={styles["sign-up-form inner-content-container"]}>
                <div className={styles["input-container"]}>
                    ...
                    <form onSubmit={handleSubmit(handleFormSubmit)} className={styles["signup-form"]}>
                        ...
                        <div className={styles["form-container"]}>
                            ...
                            <input className={styles.input}
                                ...
                                required: {
                                    value: true, message: "Please fill in a username to continue",
                                }, maxLength: {
                                    value: 18, message: "Your username cannot be longer than 18 characters",
                                },
                            })}
                            />
                            {errors.username &&
                                <p className={styles["error-message-sign-up"]}>{errors.username.message}</p>}
                            ...
                            <input className={styles.input} type="password"
                                   ...
                                   {...register("password", {
                                       required: {
                                           value: true, message: "Please fill in a password to continue",
                                       }, minLength: {
                            ...
                            />
                            {errors.password &&
                                <p className={styles["error-message-sign-up"]}>{errors.password.message}</p>}
                        </div>
                        <Button
                            type={"submit"}
                    ...
                    {loading && <p>Loading...</p>}
                    {error === true && error &&
                        <h2 className={styles["error-message-sign-up"]}>Something went wrong signing you up, please try
                            again</h2>}
                </div>
            </section>
            <footer>
